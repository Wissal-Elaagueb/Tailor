...
public interface ProductService {
	...
	List<Product> filter(String name,String color,String size,String fabric,Integer brandId,List<Integer> categoriesId,Integer pageNumber,Integer pageSize) throws BadRequestException;
